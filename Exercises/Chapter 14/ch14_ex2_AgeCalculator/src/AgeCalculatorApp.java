...
public class AgeCalculatorApp {
    ...
    public static void main(String[] args) {
        ...
        // If user's date of birth is valid
            ...
            System.out.println("Your date of birth is " + dtf.format(DOB));

            // Format and print the current date
            System.out.println("The current date is " + dtf.format(today));

            // Calculate and print the user's age
            long numDays = ChronoUnit.YEARS.between(DOB, today);
